...
3. Добавить таймауты на запросы: на просмотр товаров 1ms, на добавление/изменение 1s, на заказ 10ms, на импорт 1h, на экспорт 5m, экспорт должен блоктроваться импортом.
4. Настройки таймаутов и лимитов можно читать из файла или переменных окружения. Приоритет должен задаваться в приложении
5. Graceful shutdown
